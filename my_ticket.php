<?php
  ...
  //Avvio la sessione
    ...
    $row1 = pg_fetch_row(pg_query($dbconn, $q1)); 
	  ...
	  $q2 = "SELECT Ticket.id, Ticket.stato, Ticket.tipologia, Ticket.Titolo
           FROM Ticket Join Utente on Ticket.cod_utente = Utente.id
           WHERE Utente.id = '$row1[0]'"; 
    $ret=(pg_query($dbconn, $q2));
      ...
      $output.="<div class='row ticket-row'>
                  ...
                  <div class='col-20 ticket-row-text'>
                    <span class='ticket-table-row-text' id='$row[1]'>$row[1]</span>
                  </div>
                  <div class='col-20 ticket-row-text'>
                  ...
                  <div class='col-20 ticket-row-text'>
                    <a class='glow-on-hover btn btn-block' href='dettagli_ticket.php?numero=$row[0]'>Dettagli</a>
                  </div>
                </div>";
    }
  }
  ...
  <div class="page-container">
      ...
      <div class="container middle">
        ...
        <div class="select_title_form">
          <h2 class="text-middle-bottom">I miei ticket</h2>
        </div>
        <div class="select_form"> 
          <div class="row ticket-table">
            ...
            <div class="col-20 ticket-table-name">
              <span class="ticket-table-title">Tipologia</span>
            </div>
